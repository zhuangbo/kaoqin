...
<html>
	...
	<body>
		...
		<div id="create-report" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
				<fieldset class="form">
					<g:hiddenField name="timetable.id" value="${reportInstance?.timetable?.id}"/>
					<g:hiddenField name="teacher.id" value="${reportInstance?.teacher?.id}"/>
					<g:hiddenField name="course" value="${reportInstance?.course}"/>
